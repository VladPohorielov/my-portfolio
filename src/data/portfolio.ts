...
export const portfolioData: PortfolioData = {
  ...
  cases: [
    {
      ...
      images: [
        { src: "Статистика/1.1.webp", alt: "Кейс 01 — скрін 1", label: "Кейс 01 · Статистика" },
        { src: "Статистика/1.2.webp", alt: "Кейс 01 — скрін 2", label: "Кейс 01 · Деталі" },
      ],
      stats: [
    ...
    },
    {
      ...
      images: [
        { src: "Статистика/2.1.webp", alt: "Кейс 02 — скрін 1", label: "Кейс 02 · Статистика" },
        { src: "Статистика/2.2.webp", alt: "Кейс 02 — скрін 2", label: "Кейс 02 · Деталі" },
      ],
      stats: [
  ...
  gallery: [
    { src: "Analyze_the_bouquet_2k_202602111317.webp",              label: "Квіти · Продуктова зйомка",  overlay: "Квіти · Product Shot",          size: "tall" },
    { src: "Edit_this_photo_2k_202601161146.webp",                  label: "Косметика · E-commerce",     overlay: "Косметика · Реклама" },
    { src: "Gemini_Generated_Image_8f1o3k8f1o3k8f1o (1).webp",     label: "Ресторан · Атмосфера",       overlay: "Ресторан · Атмосфера" },
    { src: "Gemini_Generated_Image_fpiojlfpiojlfpio (1).webp",      label: "Fashion · Lifestyle",        overlay: "Fashion · Lifestyle",            size: "tall" },
    { src: "Gemini_Generated_Image_lh6mzylh6mzylh6m.webp",         label: "Brand Campaign · Banner",    overlay: "Brand Banner · Performance",     size: "wide" },
    { src: "Gemini_Generated_Image_lpchtdlpchtdlpch.webp",         label: "Tech Product · Visual",      overlay: "Tech · Visual" },
    { src: "Image_202601161105.webp",                               label: "Local Business · Outdoor",   overlay: "Local Brand · Outdoor" },
    { src: "Remove_the_black_2k_202601251453.webp",                 label: "Portrait · Avatar",          overlay: "Portrait · AI Avatar" },
    { src: "This_is_an_2k_202602111337.webp",                       label: "Product · Flat lay",         overlay: "Product · Flat lay",             size: "tall" },
    { src: "This_is_an_2k_202602111344.webp",                       label: "Seasonal · 8 Березня",       overlay: "Seasonal · 8 Березня" },
    { src: "Analyze_the_bouquet_2k_202602111321.webp",              label: "Квіти · Деталь",             overlay: "Квіти · Деталь" },
    { src: "11.webp",                                               label: "Instagram · Carousel",       overlay: "Carousel · Instagram" },
    { src: "12.webp",                                               label: "Meta Ads · Banner",          overlay: "Meta Ads · Banner",              size: "wide" },
    { src: "13.webp",                                               label: "Interior · Space",           overlay: "Interior · Design" },
    { src: "14.webp",                                               label: "Avatar · Character",         overlay: "AI Avatar · Character",          size: "tall" },
    { src: "2.webp",                                                label: "Minimal · Product Shot",     overlay: "Minimal · Product Shot" },
    { src: "3.webp",                                                label: "Neon · City",                overlay: "Neon City" },
    { src: "4.webp",                                                label: "Health · Wellness",          overlay: "Health · Wellness Brand" },
    { src: "5.webp",                                                label: "Packaging · Design",         overlay: "Packaging · Design" },
    { src: "6.webp",                                                label: "Campaign · Editorial",       overlay: "Campaign · Editorial",           size: "wide" },
    { src: "7.webp",                                                label: "Food Styling",               overlay: "Food Styling" },
    { src: "8.webp",                                                label: "Portrait · B&W",             overlay: "B&W · Portrait" },
    { src: "9.webp",                                                label: "Summer · Lifestyle",         overlay: "Summer · Lifestyle" },
    { src: "10.webp",                                               label: "Dark · Luxury Brand",        overlay: "Dark Luxury · Brand",            size: "tall" },
    { src: "Extreme_worms_eye_view_from_inside_flowersa_stylis_delpmaspu.webp", label: "Квіти · Драматичний кут", overlay: "Квіти · Драматичний кут", size: "tall" },
    { src: "_delpmaspu_19.webp",                                    label: "AI Portrait · Style",        overlay: "AI Portrait · Style",            size: "tall" },
    { src: "___________________________________________________delpmaspu (1).webp",  label: "Portrait · Concept",  overlay: "Portrait · Concept",  size: "tall" },
    { src: "___________________________________________________delpmaspu (22).webp", label: "Lifestyle · Editorial", overlay: "Lifestyle · Editorial", size: "tall" },
  ],
